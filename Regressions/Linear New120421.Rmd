...
# Goal - Predicting ltv a single DV by several IVs   
...
### Preliminary Univariate correlations
```{r, warning=FALSE, message=FALSE}
newData %>% 
...
For detecting multicollinearity we should first ran the model using the **lm** command.
